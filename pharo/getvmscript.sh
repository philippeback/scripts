...
# ARGUMENT HANDLING =============================================================
if { [ "$1" = "-h" ] || [ "$1" = "--help" ]; }; then
	echo "This script downloads the stable Pharo VM.
...
#VM_URL="http://files.pharo.org/vm/${VM_TYPE}/${OS}/centos/stable.zip"
VM_URL="http://files.pharo.org/vm/pharo/linux/centos/latest.zip"
VM_DIR="pharo-vm"
...
<p>This script downloads the stable Pharo VM.</p>
<h2>Usage</h2>
<code>curl <a href="http://get.pharo.org/vm">get.pharo.org/vm</a> | bash </code>
<br/>
or if <code>curl</code> is not available: </br>
<code>wget -O- <a href="http://get.pharo.org/vm">get.pharo.org/vm</a> | bash </code>
